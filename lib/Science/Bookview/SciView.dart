...
class Scih_view extends StatefulWidget {
  const Scih_view({Key? key}) : super(key: key);

  @override
  State<Scih_view> createState() => _Scih_viewState();
}

class _Scih_viewState extends State<Scih_view> {
